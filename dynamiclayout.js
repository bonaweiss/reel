...
function applyDynamicLayout() {
  ...
  if (width < 600 )                 { applyStylesheet("tiny") }
  if (width >= 600 && width < 720)  { applyStylesheet("thin") }
  if (width >= 720 && width < 810)  { applyStylesheet("wide") }
  if (width >= 810)                   { applyStylesheet("wider") }
}
